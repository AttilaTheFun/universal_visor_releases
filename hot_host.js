...
import { BlobWriter, Runtime, Tags, Types, decoder as ffiDecoder, encodeErrorBlob, foreignObjects, pendingCalls, registerForeign, wasiShim } from "./swift_ffi_runtime.js?v=4255577329";
import { createReactTreeRenderer } from "./runtime/react_renderer.js?v=4255577329";
import { applyPatch } from "./runtime/flat_tree.js?v=4255577329";
