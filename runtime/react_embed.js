...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=1807250267");
//   <UniversalUI wasmURL="./app.wasm?v=1807250267" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=1807250267", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=1807250267";
import { packagedBundleProvider } from "./bundle_provider.js?v=1807250267";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=1807250267", renderer = "react", style }) {
