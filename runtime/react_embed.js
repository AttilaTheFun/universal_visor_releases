...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=275816626");
//   <UniversalUI wasmURL="./app.wasm?v=275816626" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=275816626", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=275816626";
import { packagedBundleProvider } from "./bundle_provider.js?v=275816626";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=275816626", renderer = "react", style }) {
