...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=2153667916");
//   <UniversalUI wasmURL="./app.wasm?v=2153667916" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=2153667916", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=2153667916";
import { packagedBundleProvider } from "./bundle_provider.js?v=2153667916";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=2153667916", renderer = "react", style }) {
