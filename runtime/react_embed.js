...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=3492974700");
//   <UniversalUI wasmURL="./app.wasm?v=3492974700" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=3492974700", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=3492974700";
import { packagedBundleProvider } from "./bundle_provider.js?v=3492974700";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=3492974700", renderer = "react", style }) {
