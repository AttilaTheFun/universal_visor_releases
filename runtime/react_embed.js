...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=4255577329");
//   <UniversalUI wasmURL="./app.wasm?v=4255577329" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=4255577329", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=4255577329";
import { packagedBundleProvider } from "./bundle_provider.js?v=4255577329";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=4255577329", renderer = "react", style }) {
