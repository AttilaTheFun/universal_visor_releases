...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=2486051207");
//   <UniversalUI wasmURL="./app.wasm?v=2486051207" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=2486051207", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=2486051207";
import { packagedBundleProvider } from "./bundle_provider.js?v=2486051207";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=2486051207", renderer = "react", style }) {
