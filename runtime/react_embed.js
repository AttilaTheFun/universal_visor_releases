...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=969243430");
//   <UniversalUI wasmURL="./app.wasm?v=969243430" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=969243430", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=969243430";
import { packagedBundleProvider } from "./bundle_provider.js?v=969243430";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=969243430", renderer = "react", style }) {
