...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=3166119944");
//   <UniversalUI wasmURL="./app.wasm?v=3166119944" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=3166119944", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=3166119944";
import { packagedBundleProvider } from "./bundle_provider.js?v=3166119944";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=3166119944", renderer = "react", style }) {
