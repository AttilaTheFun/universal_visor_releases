...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=815442018");
//   <UniversalUI wasmURL="./app.wasm?v=815442018" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=815442018", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=815442018";
import { packagedBundleProvider } from "./bundle_provider.js?v=815442018";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=815442018", renderer = "react", style }) {
