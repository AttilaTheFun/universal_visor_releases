...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=720045069");
//   <UniversalUI wasmURL="./app.wasm?v=720045069" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=720045069", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=720045069";
import { packagedBundleProvider } from "./bundle_provider.js?v=720045069";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=720045069", renderer = "react", style }) {
