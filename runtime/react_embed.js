...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=3215733977");
//   <UniversalUI wasmURL="./app.wasm?v=3215733977" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=3215733977", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=3215733977";
import { packagedBundleProvider } from "./bundle_provider.js?v=3215733977";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=3215733977", renderer = "react", style }) {
