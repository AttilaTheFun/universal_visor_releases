...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=801136671");
//   <UniversalUI wasmURL="./app.wasm?v=801136671" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=801136671", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=801136671";
import { packagedBundleProvider } from "./bundle_provider.js?v=801136671";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=801136671", renderer = "react", style }) {
