...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=718971504");
//   <UniversalUI wasmURL="./app.wasm?v=718971504" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=718971504", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=718971504";
import { packagedBundleProvider } from "./bundle_provider.js?v=718971504";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=718971504", renderer = "react", style }) {
