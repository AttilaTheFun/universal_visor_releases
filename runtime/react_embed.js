...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=2401207005");
//   <UniversalUI wasmURL="./app.wasm?v=2401207005" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=2401207005", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=2401207005";
import { packagedBundleProvider } from "./bundle_provider.js?v=2401207005";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=2401207005", renderer = "react", style }) {
