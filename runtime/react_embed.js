...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=991770728");
//   <UniversalUI wasmURL="./app.wasm?v=991770728" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=991770728", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=991770728";
import { packagedBundleProvider } from "./bundle_provider.js?v=991770728";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=991770728", renderer = "react", style }) {
