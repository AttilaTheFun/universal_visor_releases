...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=2910434466");
//   <UniversalUI wasmURL="./app.wasm?v=2910434466" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=2910434466", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=2910434466";
import { packagedBundleProvider } from "./bundle_provider.js?v=2910434466";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=2910434466", renderer = "react", style }) {
