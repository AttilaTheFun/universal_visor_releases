...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=1980801553");
//   <UniversalUI wasmURL="./app.wasm?v=1980801553" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=1980801553", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=1980801553";
import { packagedBundleProvider } from "./bundle_provider.js?v=1980801553";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=1980801553", renderer = "react", style }) {
