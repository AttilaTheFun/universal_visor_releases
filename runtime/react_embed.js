...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=3806848074");
//   <UniversalUI wasmURL="./app.wasm?v=3806848074" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=3806848074", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=3806848074";
import { packagedBundleProvider } from "./bundle_provider.js?v=3806848074";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=3806848074", renderer = "react", style }) {
