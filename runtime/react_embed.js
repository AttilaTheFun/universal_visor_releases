...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=4027349739");
//   <UniversalUI wasmURL="./app.wasm?v=4027349739" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=4027349739", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=4027349739";
import { packagedBundleProvider } from "./bundle_provider.js?v=4027349739";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=4027349739", renderer = "react", style }) {
