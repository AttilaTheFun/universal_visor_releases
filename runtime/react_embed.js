...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=1711804959");
//   <UniversalUI wasmURL="./app.wasm?v=1711804959" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=1711804959", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=1711804959";
import { packagedBundleProvider } from "./bundle_provider.js?v=1711804959";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=1711804959", renderer = "react", style }) {
