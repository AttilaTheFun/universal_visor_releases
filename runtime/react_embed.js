...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=1616920045");
//   <UniversalUI wasmURL="./app.wasm?v=1616920045" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=1616920045", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=1616920045";
import { packagedBundleProvider } from "./bundle_provider.js?v=1616920045";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=1616920045", renderer = "react", style }) {
