...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=784985314");
//   <UniversalUI wasmURL="./app.wasm?v=784985314" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=784985314", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=784985314";
import { packagedBundleProvider } from "./bundle_provider.js?v=784985314";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=784985314", renderer = "react", style }) {
