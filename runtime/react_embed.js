...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=3694726534");
//   <UniversalUI wasmURL="./app.wasm?v=3694726534" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=3694726534", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=3694726534";
import { packagedBundleProvider } from "./bundle_provider.js?v=3694726534";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=3694726534", renderer = "react", style }) {
