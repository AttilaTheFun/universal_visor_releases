...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=1182993895");
//   <UniversalUI wasmURL="./app.wasm?v=1182993895" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=1182993895", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=1182993895";
import { packagedBundleProvider } from "./bundle_provider.js?v=1182993895";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=1182993895", renderer = "react", style }) {
