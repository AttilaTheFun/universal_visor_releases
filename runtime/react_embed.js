...
//
//   const { UniversalUI } = await import("./runtime/react_embed.js?v=625390238");
//   <UniversalUI wasmURL="./app.wasm?v=625390238" renderer="react" style={{ height: 480 }} />
//   // or, with hot reload / dynamic delivery:
//   <UniversalUI provider={appBundleProvider("./app.wasm?v=625390238", { hotReloadURL })} />

import { mountUniversalUI } from "./boot.js?v=625390238";
import { packagedBundleProvider } from "./bundle_provider.js?v=625390238";

export function UniversalUI({ provider, wasmURL = "./app.wasm?v=625390238", renderer = "react", style }) {
